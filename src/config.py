...
# ──────────────────────────────────────────────────────────────────────
TEST_FILES = {
    'gm_nor':              'Test_set_gm_nor.CSV',
    'low_speed':           'Test_set_low_speed.CSV',
    'sine_15':             'Test_set_sine_15.CSV',
    'sine_60':             'Test_set_sine_60.CSV',
    'stationary_steering': 'Test_set_stationary_steering.CSV',
    'gm_agg':              'Test_set_gm_agg.CSV',
    'gm_mu_0.4':           'Test_set_gm_mu_0.4.CSV',
    'gm_mu_0.6':           'Test_set_gm_mu_0.6.CSV',
}
